...
app.controller('QuerySelectorCtrl', ['$scope', '$http', '$window',  function($scope, $http, $window) {
    ...
    $finalData = "" //This variable will hold the query that will be sent to filter the network flows
  ...
  \
  <div class="col-lg-4" ng-show="FiltersDict[\'name1-e\']" class="ng-hide" style="margin-top: 10px;"> \
    <b> <p> value1 </p> </b> \
  ...
  \
  <div class="col-lg-2" style="padding-top:40px;" ng-show="FiltersDict[\'name1-e\'] && FiltersDict[\'name2-e\']">   \
  <div class="btn-group" data-toggle="buttons"> \
  ...
  \
<div class="col-lg-4" ng-show="FiltersDict[\'name2-e\']" class="ng-hide" style="margin-top: 10px;"> \
    <b> <p> value2 </p> </b>\
    <div class="input-group"> \
      <span class="input-group-btn"> \
