...
sectionTableTag = """
<div id = "vizDiv" class="container" style="display: none;">
...
def setPieces(current_page, records_per_page, flows, amountOfEntries):
	print setTableValues%(current_page, records_per_page, flows, amountOfEntries)
	print sectionTableTag
	print initTableScript
